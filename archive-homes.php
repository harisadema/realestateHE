...
<div class="bg-[#DCD7C9] min-h-screen text-center pt-20">
...
<div class="container mx-auto my-10 px-8 md:px-6 lg:px-8">
        <h2 class="text-4xl font-bold text-gray-900 text-center mt-6" style="font-family: 'Playfair Display', serif;">
            Find the Perfect Home for You
        </h2>
        <hr class="w-20 border-t-2 border-gray-600 mx-auto my-4">
        <p class="text-lg text-gray-700 mt-2 max-w-2xl mx-auto">
                    ...
                    <article class="bg-white shadow-md rounded-lg overflow-hidden">
                        <?php if (has_post_thumbnail()) : ?>
                            <a href="<?php the_permalink(); ?>" class="block">
                                <img src="<?php the_post_thumbnail_url('medium'); ?>" alt="<?php the_title(); ?>" class="w-full h-56 object-cover">
                            </a>
                        <?php else : 
                            ...
                            if ($default_image_id) {
                                ...
                                echo '<img src="' . esc_url($default_image_url) . '" alt="Default Home Image" class="w-full h-56 object-cover">';
                            }
                        endif; ?>
